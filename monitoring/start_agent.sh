...
docker service create --network dc1 --network dc2 --network dc3 --name monitoring_java_agent --log-opt max-size=10m --log-opt max-file=10 \
...
man4j/monitoring_java_agent:v12
